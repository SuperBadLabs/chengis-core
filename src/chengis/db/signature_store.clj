...
;; create-signature!   [ds attrs]              — overridden below (custom row defaults)
;; get-signature       [ds id & {:keys [org-id]}]
;; list-signatures     [ds & {:keys [org-id]}] — overridden below (job-id, verified, limit, offset)
;; update-signature!   [ds id updates]
;; delete-signature!   [ds id & {:keys [org-id]}]
;; count-signatures    [ds & {:keys [org-id]}]
;; ---------------------------------------------------------------------------

(defstore signature
  :table       :artifact-signatures
  :org-scoped? true
  :order-by    [[:created-at :desc]])

;; ---------------------------------------------------------------------------
;; Override: create — custom row shape with verified default
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; Override: list — adds job-id, verified, limit, offset filters
;; ---------------------------------------------------------------------------
