...
;; ---------------------------------------------------------------------------
;; Standard CRUD — generated by defstore
;; create-policy!   [ds attrs]              — overridden below (JSON, boolean, log)
;; get-policy       [ds id & {:keys [org-id]}]
;; list-policies    [ds & {:keys [org-id]}] — overridden below (policy-type, enabled-only, order-by)
;; update-policy!   [ds id updates]         — overridden below (JSON, org-id)
;; delete-policy!   [ds id & {:keys [org-id]}] — overridden below (cascaded delete + ownership check)
;; count-policies   [ds & {:keys [org-id]}]
;; ---------------------------------------------------------------------------
...
(defstore policy
  ...
  :transform   row->policy)

;; ---------------------------------------------------------------------------
;; Override: create — JSON-encode :rules, boolean :enabled, log
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; Override: list — adds policy-type, enabled-only filters
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; Override: update — JSON-encode :rules, optional org-id
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; Override: delete — cascades to policy-evaluations, verifies org ownership
;; ---------------------------------------------------------------------------
