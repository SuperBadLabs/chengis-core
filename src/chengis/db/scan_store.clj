...
;; create-scan!   [ds attrs]              — overridden below (custom row defaults)
;; get-scan       [ds id & {:keys [org-id]}]
;; list-scans     [ds & {:keys [org-id]}] — overridden below (job-id, passed, limit, offset)
;; update-scan!   [ds id updates]
;; delete-scan!   [ds id & {:keys [org-id]}]
;; count-scans    [ds & {:keys [org-id]}]
;; ---------------------------------------------------------------------------

(defstore scan
  :table       :vulnerability-scans
  :org-scoped? true
...
;; ---------------------------------------------------------------------------
;; Override: list — adds job-id, passed, limit, offset filters
;; ---------------------------------------------------------------------------
